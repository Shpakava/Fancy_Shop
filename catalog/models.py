...
class Category(models.Model):
    ...
    image = models.ImageField(verbose_name="Image", upload_to="category/%Y/%m/%d", blank=True, default="default_cat.png")
...
class Product(models.Model):
    ...
    discount = models.IntegerField(verbose_name="Discount", help_text="in percents", default=0)
    pic = models.ImageField(verbose_name="Picture", upload_to="products/%Y/%m/%d", blank=True, default="default.png")
    stock = models.PositiveIntegerField(verbose_name="Stock", default=0)
    is_available = models.BooleanField(verbose_name="available", default=False)
